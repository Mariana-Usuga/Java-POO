...
Si le queda 1 día para caducar, se reducirá 4 veces el precio final. 30%
Si le quedan 2 días para caducar, se reducirá 3 veces el precio final. 40%
Si le quedan 3 días para caducar, se reducirá a la mitad de su precio final. 50%
En NoPerecedero, hace lo mismo que en producto
Crea una clase ejecutable y crea un array de productos y muestra el precio total de vender 5  productos de cada uno. Crea tú mismo los elementos del array.v
 */
package Ejer13;
public class Productos implements PrecioProductos{
    ...
    public void calcular(int numProductos) {
        double precioT=getPrecio()*numProductos;
        setPrecio(precioT);
    }
    @Override
